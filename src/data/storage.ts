...
export function exportAll(
  ...
  const data = JSON.stringify(
    { version: 3, exportedAt: new Date().toISOString(), students, tests, lessons, grades, payments },
    null, 2
  );
...
export function gid(): string {
  return 'i' + Date.now().toString(36) + Math.random().toString(36).slice(2, 4);
}
...
const SAMPLE_STUDENTS: Student[] = [
  {
    ...
    lastContactDate: '2025-04-20', nextContactDate: '',
    enrollProbability: '', leaveReason: '',
  ...
  },
  {
    ...
    level: 'lower_intermediate', notes: '독해 강점. 문법 보완 필요.',
    status: '재원생', enrollDate: '2024-09-01', leaveDate: '',
    lastContactDate: '2025-04-28', nextContactDate: '',
    enrollProbability: '', leaveReason: '',
  ...
  },
  {
    ...
    emergencyPhone: '', address: '', email: '',
    inquiryRoute: '네이버지도', classInterest: ['중등'],
    level: '', notes: '레벨 테스트 예정.',
    status: '테스트예정', enrollDate: '', leaveDate: '',
    lastContactDate: '2025-04-29', nextContactDate: '2025-05-04',
    enrollProbability: '높음', leaveReason: '',
  ...
  },
  {
    ...
    level: 'basic', notes: '알파벳 인식 완료. 블렌딩 연습 중.',
    status: '재원생', enrollDate: '2025-01-06', leaveDate: '',
    lastContactDate: '2025-04-15', nextContactDate: '',
    enrollProbability: '', leaveReason: '',
  ...
  },
  {
    ...
    lastContactDate: '2025-04-30', nextContactDate: '2025-05-04',
    enrollProbability: '보통', leaveReason: '',
...
const SAMPLE_LESSONS: LessonLog[] = [
  {
    id: 'l1', studentId: 's1', date: '2025-04-28',
    attendance: '출석', progress: 'Unit 5 Reading Comprehension',
    homework: 'Q&A 3문제 완성', reaction: '집중 잘 됨.', memo: '다음 시간 Unit 6 예습 권장',
  },
  {
    id: 'l2', studentId: 's1', date: '2025-04-21',
    attendance: '지각', progress: 'Unit 4 Grammar Review',
    homework: '단어 20개 암기', reaction: '조금 피곤해 보임.', memo: '20분 늦게 도착.',
  },
  {
    id: 'l3', studentId: 's2', date: '2025-04-30',
    attendance: '출석', progress: 'Chapter 7 Critical Reading',
    homework: 'Summary 1편 작성', reaction: '매우 적극적.', memo: '',
  },
];

const SAMPLE_GRADES: GradeRecord[] = [
  {
    id: 'g1', studentId: 's1', quarter: '2025-Q1', date: '2025-03-28',
    level: 'basic',
    readingComprehension: { score: 38, maxScore: 50 },
    vocabulary:           { score: 22, maxScore: 30 },
    sentenceBuilding:     { score: 14, maxScore: 20 },
    writingTest:          { score: 0,  maxScore: 0  },
    speaking: 7, attendance: 4, attitude: 4,
    summary: '꾸준히 출석하며 Reading에서 눈에 띄는 성장을 보였습니다. Writing 영역은 꾸준한 연습이 필요합니다.',
...
const SAMPLE_PAYMENTS: Payment[] = [
  ...
  { id: 'p5', studentId: 's4', month: '2025-04', amount: 140000, isPaid: true,  paidDate: '2025-04-02', paymentMethod: '현금', memo: '현금 영수증' },
