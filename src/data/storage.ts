...
const SAMPLE_STUDENTS: Student[] = [
  {
    id:'s1', name:'김지호', grade:'초3', school:'행복초', birthdate:'2016-03-15',
    studentPhone:'', parentPhone:'010-1234-5678', inquiryRoute:'블로그',
    classInterest:['기본반'], currentBook:'English for Everyone Beginner',
  ...
  {
    id:'s2', name:'박서연', grade:'초5', school:'희망초', birthdate:'2014-07-22',
    studentPhone:'010-9876-5432', parentPhone:'010-8765-4321', inquiryRoute:'소개',
    classInterest:['성장반'], currentBook:'Multiple Reading Skills C',
  ...
  {
    id:'s3', name:'이준서', grade:'중1', school:'미래중', birthdate:'2012-11-05',
    studentPhone:'010-5555-1234', parentPhone:'010-4444-5678', inquiryRoute:'네이버지도',
    classInterest:['중등'], currentBook:'', level:'',
  ...
  {
    id:'s4', name:'최아린', grade:'초2', school:'별빛초', birthdate:'2017-02-14',
    studentPhone:'', parentPhone:'010-2222-3333', inquiryRoute:'전단지',
    classInterest:['파닉스'], currentBook:'Smart Phonics 3',
  ...
  {
    id:'s5', name:'홍민준', grade:'성인', school:'-', birthdate:'1990-06-30',
    studentPhone:'010-7777-8888', parentPhone:'', inquiryRoute:'블로그',
    classInterest:['성인'], currentBook:'Side by Side 1',
